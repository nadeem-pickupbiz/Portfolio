...
import photo from "../Components/image/photo.avif";
...
const Navbar = () => {
  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 bg-sky-300">
        <div className="flex justify-between items-center h-16">
          <div className="flex space-x-2">
            <img src={photo} alt="" className="w-12 h-12 rounded-full" />
            <h1 className="font-semibold text-xl cursor-pointer">
              Nadeem <span className="text-green-500 text-2xl">Sk</span>
